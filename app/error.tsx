  ...
  return (
    <div className="min-h-screen bg-white text-black overflow-hidden relative">
      ...
      <div className="relative z-20 min-h-screen flex flex-col items-center justify-center px-4 sm:px-6 text-center">
        ...
        >
          ...
          >
            <div className="relative inline-block">
              <motion.div
                ...
                className="w-24 h-24 mx-auto mb-6 bg-red-50 border border-red-200 rounded-full flex items-center justify-center"
              >
              ...
              <motion.div
                ...
                className="absolute inset-0 w-32 h-32 -m-4 border border-red-200 rounded-full"
              />
              <motion.div
                initial={{ scale: 0, opacity: 0 }}
                animate={{ scale: 1, opacity: 0.2 }}
                transition={{ delay: 1.2, duration: 0.8 }}
                className="absolute inset-0 w-40 h-40 -m-8 border border-red-100 rounded-full"
              />
            </div>
          </motion.div>
          ...
          <motion.div
            ...
            className="mb-8"
          >
            <p className="text-red-600 text-sm tracking-[0.3em] uppercase mb-4">
              {isNetworkError ? 'Connection Error' : 'Application Error'}
            </p>
            <h1 className="font-playfair text-4xl sm:text-5xl lg:text-6xl mb-6">
              Something Went Wrong
            </h1>
            <p className="text-xl text-gray-600 font-light leading-relaxed max-w-lg mx-auto mb-4">
              {isNetworkError 
            ...
            {process.env.NODE_ENV === 'development' && (
              ...
              >
                ...
                <div className="bg-gray-50 border border-gray-200 rounded-lg p-4 text-xs font-mono text-gray-600 overflow-auto max-h-32">
          ...
          >
            <motion.button
              ...
              className={cn(
                "btn-luxury px-6 py-3 flex items-center justify-center gap-3",
      ...
      <motion.div
        ...
        className="absolute top-1/3 left-1/5 w-1 h-1 bg-red-300 rounded-full"
      />
      ...
      <motion.div
        ...
        className="absolute top-2/3 right-1/4 w-2 h-2 bg-red-200 rounded-full"
      />
    </div>
  )
}